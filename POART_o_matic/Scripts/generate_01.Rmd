...
# 
# # Functions used
# loom_funcs <- here("POART_o_matic/functions/00_loom.R")
# 
...
template <- list.files(path = here("POART_o_matic/templates"),
                              full.names = TRUE,
                             pattern = "_01_")
```
...
output_loc <- glue(here("POART_o_matic/Slides/Cumulative_Achievement_{ou_name}_{indicator}_{FY_min}_{FY_max}.pptx"))
